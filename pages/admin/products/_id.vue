        ...
        <div class="col-md-6 offset-md-3">
          ...
          <b-form ref="productForm">
            ...
            <b-form-group label="Title:" label-for="productTitle"
              ...
              <b-form-input id="productTitle" v-model="product.title" type="text" required
            ...
            <b-form-group label="Description: " label-for="productDescription">
              <b-form-textarea id="productDescription" v-model="product.description"
            ...
            <b-form-group label="Photo:" label-for="productPhoto">
              ...
              <b-form-file @change="imagesAdd" :file-name-formatter="formatNames" ref="imagesInput" multiple
                id="productPhoto" title=" "></b-form-file>
              <!-- <b-form-file @change="onFileSelected($event)" :file-name-formatter="formatNames" id="productPhoto"></b-form-file> -->
              <b-alert class="my-2" show variant="warning">Note: Uploading new images will replace the existing
                images</b-alert>
            </b-form-group>
            ...
            <b-form-group label="Price:" label-for="productPrice"
              ...
              <b-form-input id="productPrice" v-model="product.price" type="number" required
            ...
            <b-form-group label="Stock Quantity:" label-for="stockQuantity"
              ...
              <b-form-input id="stockQuantity" v-model="product.stockQuantity" type="number" required
